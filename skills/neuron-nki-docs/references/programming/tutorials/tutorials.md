...
[nki-samples](https://github.com/aws-neuron/nki-samples/tree/main/src/nki_samples/tutorials/) repository on GitHub.
...
[2D Transpose](transpose2d.md)
Implement efficient 2D matrix transpose operations using NKI

[Average Pooling 2D](average_pool2d.md)
