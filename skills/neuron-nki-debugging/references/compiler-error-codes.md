# Neuron Compiler Error Codes (NCC\_\*)
...
Neuron Compiler error codes (NCC\_\* prefix) indicate issues during NEFF generation from NKI kernels. These errors occur during the compilation phase after NKI kernel code has been successfully parsed but before executable NEFF files can be generated.
...
NCC\_\* errors occur during the neuronx-cc phase when generating NEFF files from the intermediate representation.

## Best Practices

**When encountering NCC\_\* errors**:
